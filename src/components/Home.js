        ...
        <div className="container marketing">
          ...
          <div className="row">
            ...
            <img src={toy1Image} alt="toy1.webp" className="rounded-circle" width="140" height="140" role="img" aria-label="Placeholder" />
              ...
              <p>Elevating Your Pet's Lifestyle with Superior Supplies</p>
              <p><a className="btn btn-secondary" href="#">View details &raquo;</a></p>
            </div>
          </div>
          ...
          <div className="row featurette">
            <div className="col-md-7">
              ...
              <p className="lead">Discover the best in canine companionship at Our Dogs! With a handpicked selection of top-notch breeds, we're committed to matching you with your perfect furry friend. From playful pals to loyal companions, find your ideal match with ease. Experience the joy of dog ownership with Our Dogs today! 🐶</p>
            </div>
          ...
          <div className="row featurette">
            <div className="col-md-7 order-md-2">
              ...
              <p className="lead">Welcome to Our Cats, your destination for feline companionship! Dive into our curated collection of fabulous felines and find the purr-fect match for your home. Whether you're seeking a snuggly lap cat or an adventurous explorer, we've got the ideal kitty companion just waiting to join your family. Embrace the love and warmth of cat ownership with Our Cats today! 🐾</p>
            </div>
